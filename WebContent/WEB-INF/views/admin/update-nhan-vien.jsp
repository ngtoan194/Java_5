...
<div class="table">
	<form:form action="quan-ly-nhan-vien" modelAttribute="nhan_vien"
		...
		<table class="listing form" cellpadding="0" cellspacing="0">
			<tr>
				<th class="full" colspan="2">Sửa nhân viên
			...
			<tr>
				...
				<td class="last"><input value="${nhan_vien.TUOI}" type="number" name="tempAge"/>
				<form:errors path="TUOI" element="span"/></td>
			</tr>

			<tr class="bg">
				<td class="first"><strong>Ảnh hiện tại</strong></td>
				<td class="last"><img src="${currentAvatar}" width="100px" height="auto"><input name="currentAvatar" value="${currentAvatar}" hidden/></td>
			</tr>
		...
		<!-- <h3 style="color: red;">${mess}</h3> -->
		<button class="btn btn-default" name="edit">Update</button>
	</form:form>
</div>
