...
<div class="table">
	<form:form action="edit" modelAttribute="loai_phong" method="post"
		...
		<table class="listing form" cellpadding="0" cellspacing="0">
			<tr>
				<th class="full" colspan="2">Thêm loại phòng
					<h3 style="color: red;">${message }</h3>
				</th>
			</tr>
			<tr>
				<td class="first" width="172"><strong>Mã loại phòng</strong></td>
				<td class="last"><form:input path="ID_LP" />
					<form:errors path="ID_LP" /></td>
			</tr>
			<tr class="bg">
				<td class="first"><strong>Tên loại phòng</strong></td>
				<td class="last"><form:input path="TEN_LOAI" />
					<form:errors path="TEN_LOAI" /></td>
			</tr>
			<tr>
				<td class="first"><strong>Mô tả</strong></td>
				<td class="last"><form:textarea path="MO_TA" rows="4" cols="26" />
					<form:errors path="MO_TA" /></td>
			</tr>
			<tr class="bg">
				...
				<td class="last"><input
					...
					name="anh" />
				<form:errors path="ANH" /></td>
			</tr>
		</table>
		<h3 style="color: red;">${mess3}</h3>
		<button class="btn btn-default" name="insert">Update</button>
	</form:form>
</div>
